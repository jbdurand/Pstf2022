...
${OBJECTDIR}/Sources/StdAfxVectorAndMatrix.o: Sources/StdAfxVectorAndMatrix.cpp
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sources/StdAfxVectorAndMatrix.o Sources/StdAfxVectorAndMatrix.cpp

${OBJECTDIR}/Sources/cGSLMatrix.o: Sources/cGSLMatrix.cpp
	${MKDIR} -p ${OBJECTDIR}/Sources
	${RM} "$@.d"
	$(COMPILE.c) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sources/cGSLMatrix.o Sources/cGSLMatrix.cpp

${OBJECTDIR}/Sources/cGSLVector.o: Sources/cGSLVector.cpp
	${MKDIR} -p ${OBJECTDIR}/Sources
	${RM} "$@.d"
	$(COMPILE.c) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sources/cGSLVector.o Sources/cGSLVector.cpp
