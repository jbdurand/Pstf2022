...
LDLIBSOPTIONS=-L../Error/build/Debug/GNU-Linux -L../VectorAndMatrix/build/Debug/GNU-Linux -Wl,-rpath,'../VectorAndMatrix/dist/Debug/GNU-Linux' -L../VectorAndMatrix/dist/Debug/GNU-Linux -lVectorAndMatrix -Wl,-rpath,'../Error/dist/Debug/GNU-Linux' -L../Error/dist/Debug/GNU-Linux -lError -lgsl -lgslcblas

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/exampledebug

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/exampledebug: ../VectorAndMatrix/dist/Debug/GNU-Linux/libVectorAndMatrix.so
